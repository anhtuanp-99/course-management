...
/**
 * SecurityConfig: Cấu hình bảo mật chung.
 * Phân quyền chi tiết được đặt tại từng Controller bằng @PreAuthorize.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    /**
     * Cấu hình CORS cho phép các origin cụ thể (React, Vite...).
     */
    @Bean
